...
git add package.json pnpm-workspace.yaml vitest.config.ts tsconfig.base.json tsconfig.typedoc.json typedoc.json .gitignore LICENSE .changeset .github scripts pnpm-lock.yaml
