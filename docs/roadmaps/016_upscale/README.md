...
4× upscaling of old photos/screenshots/art, universal consumer feature, immediately visually convincing. Also the first package where **tiling and memory discipline** matter (a 2048² input naive-4x'd will OOM a tab), which forces core to grow a proper tensor-memory story.
