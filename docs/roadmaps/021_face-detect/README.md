...
Pulled out of phase order: smallest end to end slice. One call, one small model, visual pass or fail. Exercises lazy loading through the registry, cache persistence, progress events, dynamic import laziness.
...
- [ ] Realtime mode ≥ 20fps on 2020 laptop (Video mode), implemented, unbenchmarked
