...
Fitness, rehab, motion capture, dance games. Second largest realtime vision vertical after faces. Same MediaPipe integration burden as face-mesh, same fix: one import, webcam loop handled.
...
- Same provider and wasm sharing as face-mesh via core cache; second mediapipe package validates shared wasm
