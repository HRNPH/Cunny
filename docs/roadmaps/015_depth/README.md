...
Monocular depth powers photo relighting, bokeh, parallax and AR occlusion. Today it means porting a research repo to ONNX. Relative depth (no metric scale) is sufficient for these uses.
