...
Face tracking for AR filters with zero setup. MediaPipe JS is callback heavy and under documented; every project writes the same webcam loop and matrix plumbing.
